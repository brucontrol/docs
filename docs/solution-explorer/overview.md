...
The **Solution Explorer** is the tree panel on the left side of BruControl. It organizes your project into folders and items.

## Top-Level Folders

| Folder | Contents |
|--------|----------|
| **Workspaces** | Your dashboards; each workspace has elements (buttons, timers, devices, etc.) |
