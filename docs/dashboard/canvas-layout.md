...
|----------|-------|---------|
| cols | 500 | Fine horizontal snap (20 px per column) |
| rowHeight | 20 | Row height in pixels |
| width | 10000 | Fixed canvas width in pixels |
| margin | [0, 0] | Gap between items (x, y) |
| containerPadding | [0, 0] | Same as margin |
...
| Digital Input, Digital Output | 6 × 4 |
| Duty Cycle, PWM Output, Analog Input | 6 × 5 |
| Chart, Profile | 6 × 6 |
| Counter, Hydrometer, Hysteresis, PID, Deadband | 6 × 6 |
| Generic | 5 × 3 |
...
- The 16000 × 16000 px canvas is large enough for complex layouts, but use **Fit to view** if elements get scattered
